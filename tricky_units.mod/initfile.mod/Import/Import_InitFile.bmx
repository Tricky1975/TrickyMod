...
' 15.08.31 - Deprecated
' 15.11.09 - Is going to bother you when you still use it!
...
MKL_Version "Tricky's Units - InitFile.bmx","15.11.09"
MKL_Lic     "Tricky's Units - InitFile.bmx","ZLib License"

Notify "WARNING! This program uses the deprecated Tricky_Units.InitFile! Please remove it from this program and replace it with Tricky_Units.InitFile2, or ask the developer to remove it!"
Print "WARNING! This program uses the deprecated Tricky_Units.InitFile! Please remove it from this program And Replace it with Tricky_Units.InitFile2, or ask the developer to remove it!"
