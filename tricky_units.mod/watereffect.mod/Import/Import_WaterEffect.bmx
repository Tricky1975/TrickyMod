...
' 15.02.24 - Initial version
' 16.06.12 - Adepted for BlitzMax NG
...
For ak=0 Until f
	...
	If horizontaal 
		ay:+ak 
		SetScale Float(wscale),1
	Else 
		ax:+ak
		SetScale 1,Float(wscale)
		EndIf
...
MKL_Version "Tricky's Units - WaterEffect.bmx","16.06.12"
