...
MKL_Version "JCR6 - JCR6_Main.bmx","17.04.27"
MKL_Lic     "JCR6 - JCR6_Main.bmx","Mozilla Public License 2.0"

Private
Const DEBUG = False
Public
Global JCRCREATECHAT = False
...
Type DRV_JCR6 Extends DRV_JCRDIR
	...
	If ret.Config.B("__CaseSensitive") 
		JCR_JAMERR("Case senstive JCR files no longer supported!",fil,"N/A","Dir()") End
...
For m=EachIn MapKeys(JCRDIR.MainFiles)
	If Not( Prefixed(m,"incbin::") Or Prefixed(m,"http::") )
