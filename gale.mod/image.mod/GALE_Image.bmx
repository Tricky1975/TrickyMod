...
MKL_Version "GALE - GALE_Image.bmx","15.09.02"
...
Type TJBC_Lua_Image  ' BLD: Object Image\nIn this object you can find all sorts of stuff on the graphic front and most of all images
  ...
  Field DontUseSpecial = False ' BLD: When set to 1 the Special load abilties of Image.Load will be ignored. When set to 0, everything will load
